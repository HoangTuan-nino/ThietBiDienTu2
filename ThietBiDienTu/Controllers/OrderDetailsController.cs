...
namespace ThietBiDienTu.Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderDetailID,OrderID,ProductID,UnitPriceSale,QuantitySale")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderDetailID,OrderID,ProductID,UnitPriceSale,QuantitySale")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
